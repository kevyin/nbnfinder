...
class Domain(unittest.TestCase):
	...
	def test_domain(self):
		driver = self.driver
		driver.get(self.base_url + "/search/buy/state/nsw/area/eastern-suburbs/sydney-city/region/sydney-region/suburb/darlinghurst/east-sydney/strawberry-hills/surry-hills/?ssubs=1&bedrooms=1&to=750000&searchterm=2010&features=broadband+internet+access%7c2&sort=date-asc")
